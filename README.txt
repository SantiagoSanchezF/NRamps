...
INSTALLATION:
    we recommend cloning this file with git. Downloading the .zip file wont get the .pkl models in /models/ directory, due to the lsf protocol used for large files.
    from this folder:
